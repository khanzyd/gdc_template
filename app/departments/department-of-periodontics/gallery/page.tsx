...
export default function Page() {
  let arr: React.JSX.Element[] | { src: string; title: string }[] = [
    {
      src: "/departments/department-of-periodontics/Undergraduate Clinic.jpg",
      title: "Undergraduate Clinic",
    },
    {
      src: "/departments/department-of-periodontics/Post Graduate Clinic.jpg",
      title: "Post Graduate Clinic",
    },
    {
      src: "/departments/department-of-periodontics/Special Operatory for LASER & Implantology.jpg",
