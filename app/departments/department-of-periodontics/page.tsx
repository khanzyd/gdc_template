      ...
      <div className="min-h-screen flex flex-col p-3">
        ...
        <div className="flex flex-wrap gap-8 mt-8">
          ...
          <div className="flex-auto basis-1/3 flex flex-col justify-center items-center">
            <img
              src={
                "/departments/department-of-periodontics/Undergraduate Clinic.jpg"
              }
          ...
          <div className="flex-auto basis-1/3 flex flex-col justify-center items-center">
            <img
              src={
                "/departments/department-of-periodontics/Post Graduate Clinic.jpg"
              }
              alt="Department Image"
              className="rounded max-w-[300px] max-h-[200px] lg:max-w-[500px] lg:max-h-[300px]"
            />
          ...
          <div className="flex-auto basis-1/3 flex flex-col justify-center items-center">
            <img
              src={
                "/departments/department-of-periodontics/Special Operatory for LASER & Implantology.jpg"
              }
              alt="Department Image"
              className="rounded max-w-[300px] max-h-[200px] lg:max-w-[500px] lg:max-h-[300px]"
            />
          ...
          <div className="w-full text-center">
            <a
              ...
              href="/departments/department-of-periodontics/gallery"
            >
              View More
            </a>
          </div>
