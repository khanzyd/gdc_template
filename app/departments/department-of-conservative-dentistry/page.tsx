      ...
      <div className="sm:flex hidden basis-1/5 border-r-[#82251b6e] border-r-2 ">
        <div className=" w-full flex flex-col gap-2 items-start justify-start p-4">
          <Link
            ...
            href={`/departments/department-of-conservative-dentistry/#about`}
          >
            About
          </Link>
          <Link
            className=" w-full rounded shadow-md outline-1 outline-[#82251b67] outline pl-4 py-3 text-lg font-medium text-neutral-500 hover:text-orange-600"
            href={`/departments/department-of-conservative-dentistry/#faculty`}
          >
            Faculty
          </Link>
          <Link
            className=" w-full rounded shadow-md outline-1 outline-[#82251b67] outline pl-4 py-3 text-lg font-medium text-neutral-500 hover:text-orange-600"
            href={`/departments/department-of-conservative-dentistry/#vision`}
          >
            Vision
          </Link>
          <Link
            className=" w-full rounded shadow-md outline-1 outline-[#82251b67] outline pl-4 py-3 text-lg font-medium text-neutral-500 hover:text-orange-600"
            href={`/departments/department-of-conservative-dentistry/#mission`}
          >
            Mission
          </Link>
          <Link
            className=" w-full rounded shadow-md outline-1 outline-[#82251b67] outline pl-4 py-3 text-lg font-medium text-neutral-500 hover:text-orange-600"
            href={`/departments/department-of-conservative-dentistry/#videos`}
          >
            Videos
          </Link>
        </div>
