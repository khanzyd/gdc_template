      ...
      <>
        <div className="bg-[#82261B] hidden text-white justify-end px-16 items-center font-semibold tracking-wide text-sm sm:flex">
          ...
          <SecondaryNavbarItem>
            ...
            target="_blank"
              href={
                "https://www.facebook.com/profile.php?id=100063937994949&mibextid=ZbWKwL"
              }
            >
              Facebook
            </Link> */} Facebook
        ...
        <div className="bg-[var(--primary-color)] text-white flex flex-col py-2 text-sm shadow-lg font-semibold max-sm:p-4 pr-44 max-sm:pr-8 select-none">
          <button
            onClick={() => setIsOpen(!isOpen)}
            className="max-sm:block hidden self-end"
          >
            <svg
          ...
          <div
            className={`items-center justify-end tracking-wide relative sm:flex ${
              isOpen ? "block" : "hidden"
            }`}
          >
            ...
            <DropDownMenu
              links={[
                ...
                { name: "INFRASTRUCTURE", ref: "/about-us/infrastructure" },
                {
                  ...
                  ref: "/about-us/college-certification",
                },
            ...
            <DropDownMenu
              links={[
                ...
                },
                {
                  ...
                  ref: "/departments/administrative-office",
                },
              ]}
            >
              DEPARTMENTS
            ...
            <DropDownMenu
              links={[
                { name: "ANTI RAGGING", ref: "/student-portal/anti-ragging" },
                {
                  ...
                  ref: "/student-portal/mentorship-programme",
                },
                { name: "BUDDY SYSTEM", ref: "/student-portal/buddy-system" },
                {
                  name: "STUDENT COUNCIL",
                  ref: "/student-portal/student-council",
                },
                {
                  name: "PARENT-TEACHER ASSOCIATION",
                  ref: "/student-portal/parent-teacher-association",
                },
                { name: "STUDENT INFO", ref: "/student-portal/student-info" },
                {
                  name: "STUDENTS'S ACHIEVEMENTS",
                  ref: "/student-portal/students-achievements",
                },
                { name: "ACADEMIC", ref: "/student-portal/academic" },
                {
                  name: "EDUCATIONAL RESOURCES",
                  ref: "/student-portal/educational-resources",
                },
                {
                  name: "CARRIER GUIDANCE CELL",
                  ref: "/student-portal/carrier-guidance-cell",
                },
                {
                  name: "FEEDBACK AND VALIDATION",
                  ref: "/student-portal/feedback-and-validation",
                },
                {
                  name: "INTERNATIONAL STUDENTS CELL",
                  ref: "/student-portal/international-students-cell",
                },
                { name: "NSS & NCC", ref: "/student-portal/nss-and-ncc" },
                {
                  name: "EQUAL OPPORTINITY CELL",
                  ref: "/student-portal/equal-opportinity-cell",
                },
              ]}
            >
              STUDENT PORTAL
            ...
            <DropDownMenu
              links={[
                {
                  name: "RESEARCH DIRECTOR'S MESSAGE",
                  ref: "/research/research-directors-message",
                },
                { name: "PRADAN", ref: "/research/pradan" },
                {
                  name: "ETHICAL COMMITTEE",
                  ref: "/research/ethical-committee",
                },
                { name: "RESEARCH AWARDS", ref: "/research/research-awards" },
                {
                  name: "MOU'S & COLLABORATION",
                  ref: "/research/mous-collaboration",
                },
                {
                  name: "RESEARCH PROJECTS",
                  ref: "/research/research-projects",
                },
                {
                  name: "RESEARCH FUNDINGS",
                  ref: "/research/research-fundings",
                },
                {
                  name: "RESEARCH PUBLICATIONS",
                  ref: "/research/research-publications",
                },
                { name: "PATENTS", ref: "/research/patents" },
                { name: "COPYRIGHTS", ref: "/research/copyrights" },
                { name: "INNOVATIONS", ref: "/research/innovations" },
                {
                  name: "INTERDESCIPLINARY ACTIVITIES",
                  ref: "/research/interdesciplinary-activities",
                },
              ]}
            >
              RESEARCH
