...
function Faculty(props: {profilePicSrc: string, cvSrc: string, facultyName: string, facultyDesignation:string}) {
    return (
      <div className=" max-w-[200px] h-[340px] overflow-hidden shadow-md outline outline-gray-300 outline-1 rounded flex flex-col justify-center items-center text-center">
        <Image
